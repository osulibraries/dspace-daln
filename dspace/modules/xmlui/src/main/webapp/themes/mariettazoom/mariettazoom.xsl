...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
	...
	<xsl:import href="../marietta/marietta.xsl" />
...
function switchZoomImage(pffFilename)
{
      ...
      */
      ...
      {
        flash.LoadMovie(0, "/themes/mariettazoommulti/dummy.swf");  
      }
      flash.LoadMovie(0, "/themes/mariettazoommulti/ZAS.swf");
      ...
      flash.SetVariable("gServerIP", "drc.library.marietta.edu");
