...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:import href="../sscc-Flash/flash.xsl" />
	<xsl:import href="../sscc-LearningObjects/sscc.xsl" />
	<!-- Had to comment out fedsearch in SSCC because this overides ds-options which already has customized xsl transforming this section in SSCC's theme. -->
