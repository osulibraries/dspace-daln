...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
	...
	<xsl:import href="../Toledo/Toledo.xsl" />
  ...
  */
  ...
  function switchZoomImage(pffFilename)
  {
        ...
        */
        ...
        {
          flash.LoadMovie(0, "/themes/pff_utol/dummy.swf");  
        }
        flash.LoadMovie(0, "/themes/pff_utol/ZAS.swf");
        ...
        flash.SetVariable("gServerIP", "drc.library.utoledo.edu");
