...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:template match="/dri:document">
		<html>
						...
						<div id="content_rht">
							<div id="content_lft">
								<div id="content_wrap">
									...
									<div id="topLineNav_wrap" style="display: block">
										<a name="menu" id="menu" />
										<ul id="topLineNav">
											<li>
												<a target="_self"
									...
									<div id="navContent_wrap">
										<div id="navContentOverflow" align="left">
											<div id="lftNavHold">
												<div id="navHead" class="navHead">Quick Links</div>
												<div id="lftNav_wrap" class="lftNav_wrap">
													<ul>
														<li>
															<a target="_self" href="http://utmost.cl.utoledo.edu/search" title="" class="">UT Library Catalog</a>
															 | 
															<a target="_self" href="http://www.utoledo.edu/library/find/reserves.html" title="" class="">Reserves</a>
														</li>
														<li>
															<a target="_self" href="http://utmost.cl.utoledo.edu/patroninfo/" title="" class="">Your Library Record</a>
															 | 
															<a target="_self" href="http://illiadvm00.utad.utoledo.edu/illiad/TOL/logon.html" title="" class="">ILLiad</a>
														</li>
														<li>
															Research
															Databases
														...
														<li>
															<a target="_self" href="http://www.ohiolink.edu" title="" class="">OhioLINK</a>
															 | 
															<a target="_self" href="http://drc.ohiolink.edu" title="" class="">OhioLINK DRC</a>
														</li>
														<li>
															<a
																target="_self"
			...
			<!-- Jeff. UT page edits Sep-2009. Removing the H3 heading of left nav search area
				<h3 id="ds-search-option-head" class="navHead"><i18n:text>xmlui.dri2xhtml.structural.search</i18n:text></h3>
			-->
			<!-- Jeff. UT page edits Sep-2009. Removing the left nav Search box area. They want just the main search in center
			<div id="ds-search-option" class="ds-option-set lftNav_wrap">
				*begin comment* The form, complete with a text box and a button, all built from attributes referenced from under pageMeta. *end comment*
			...
			*begin comment* The "Advanced search" link, to be perched underneath the search box *end comment*
				<ul>
					<li>
						<a>
			...
			<!-- Jeff. UT page edits Sep-2009. Removing left side Ward M. Canaday links
												<div style="display: block;" id="relateHead" class="navHead">Ward M. Canaday Center for Special Collections</div>
												<div style="display: block;" class="lftNav_wrap" id="relateNav_wrap">
													<a target="_self"
											...
											<div id="textHold_wrap">
												<div id="textHold">
												<!-- Jeff. UT page edits Sep-2009. Removing a far right side column of UT specific links
													<div style="display: block;" id="rhtNav_bg" class="rhtNav_bg">
														<div id="rhtNavHead">Ward M. Canaday Center Manuscript Collection<br /></div>
														<div id="rhtNav">
															<ul>
																<li>
																	<a
														...
														<p
															style="clear: both;" />
													</div>*begin comment* rhtNav_bg *end comment*
												-->	
    ...
    <xsl:template match="dri:div/dri:head" priority="3">
        ...
        <xsl:element name="h{$head_count}">
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <!-- Jeff 9-8-2009. Ignore using the default font-sizing variable function (defined above) for UT's theme:
					<xsl:attribute name="style">font-size: <xsl:value-of select="$font-sizing"/>%;</xsl:attribute>
					...and just set it to a fixed size of 160% -->
