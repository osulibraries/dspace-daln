...
-->
    ...
    <xsl:template match="mets:fileGrp[@USE='CONTENT']/mets:file[@MIMETYPE='video/x-flv']" mode="flashplay" >
	 ...
	 <param name="wmode" value="opaque" /> <!-- This is so the SSCC top navigation appears over the movie player when it expands -->
<embed src="/themes/Flash/lib/player_flv_maxi.swf" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer" TYPE="application/x-shockwave-flash" WIDTH="480" HEIGHT="385" allowFullScreen="true" wmode="opaque" Flashvars="flv={mets:FLocat/@xlink:href}&amp;width=480&amp;height=385&amp;showstop=1&amp;showvolume=1&amp;showtime=1&amp;showfullscreen=1&amp;bgcolor1=9999ff&amp;bgcolor2=cacafc&amp;playercolor=333333i&amp;showplayer=always&amp;showiconplay=1&amp;iconplaycolor=ffffff" />
