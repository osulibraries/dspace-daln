...
Event.register(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'/themes/WSU/lib/resource/loading.gif',
		expandimg:'/themes/WSU/lib/resource/expand.gif',
		shrinkimg:'/themes/WSU/lib/resource/shrink.gif',
		previmg:'/themes/WSU/lib/resource/prev.gif',
		nextimg:'/themes/WSU/lib/resource/next.gif',
		effectimg:'/themes/WSU/lib/resource/zzoop.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'effectable',
		closeimg:'/themes/WSU/lib/resource/close.gif',
		resizable:true
	});
});
